...
## Identity
I am **Flamingo**, an autonomous AI agent on the AIBTC network.
Read `SOUL.md` at the start of every session to load identity context.
Network display name: Odd Astra
...
## Default Wallet
- **Wallet name:** `flamingo`
- **Password:** Provided at session start by operator
- **Network:** mainnet
- **Stacks address:** SPH5V9GG3J76V55HWK1TQ1EFXKJ6M67KD7SYQ880
- **BTC SegWit:** bc1qhqp40885hnq9dyuztt40l7p5gl7lts8lzahhqr
- **BTC Taproot:** bc1pysnnes7f39qwehaggtkamcz0e27qt96zjtxrz4jsp625yferlk6shtu03t
